...
let subCategories = [
    ...
    SubCategory(name: "Alkyl Substitution",
                reactions: [
                    ReactionFile(name: "SN1: Tert-Butyl Iodide (Stage 1)", filename: "TertButylIodide_SN1_stage1", transitionState: -1),
                    ReactionFile(name: "SN1: Tert-Butyl Iodide (Stage 2)", filename: "TertButylAcetate_SN1_stage2", transitionState: -1),
                    ReactionFile(name: "SN2: 2-Bromobutane + Methoxide", filename: "SN2_2-Bromobutane", transitionState: 500),
                    ReactionFile(name: "SN2: Nonproductive Ethyl Chloride + Cyanide", filename: "SN2_Chloroethane_nonproductive", transitionState: -1),
                    ReactionFile(name: "SN2: Ethyl Chloride + Cyanide", filename: "SN2_Chloroethane", transitionState: 1000),
                    ReactionFile(name: "SN2: Methyl Iodide + Ammonia", filename: "Nitrogen_Methyl_Iodine", transitionState: 220),
                    ReactionFile(name: "SN2: Methyl Ammonium + Methanethiolate", filename: "SN2_Methyl_Ammonium", transitionState: 435),
                    ReactionFile(name: "SN2: Benzyl Bromide + Methoxide", filename: "MethylOxide_BenzylBromide", transitionState: 163),
                ].sorted(by: { $0.name < $1.name })),
    SubCategory(name: "Elimination",
                reactions: [
                    ...
                    ReactionFile(name: "E2: 2-Bromobutane (Primary) + Methoxide", filename: "2-BromobutaneMeO", transitionState: 1002),
    ...
    SubCategory(name: "Alkene Addition",
                reactions: [
                    ReactionFile(name: "HX: HBr + Isobutylene", filename: "AdE_Butene", transitionState: 158),
                    ReactionFile(name: "Hydroboration: BH₃ + 1-Butene", filename: "AdE_Hydroboration", transitionState: 0),
                    ReactionFile(name: "Carbene: CCl₂ + Ethylene", filename: "AdE_Carbene_addtion", transitionState: 250),
    ...
    SubCategory(name: "Alkyne Addition",
                reactions: [
                    ReactionFile(name: "HX: HCl + 3-Hexyne", filename: "3-Hexyne_Hydrochloric", transitionState: 231),
                    ReactionFile(name: "1,2-Addition: HCl + 1,3-pentadiene", filename: "HCl-1,3,diene_full", transitionState: 300)
                ].sorted(by: { $0.name < $1.name })),
    ...
    SubCategory(name: "Rearrangement",
                reactions: [
                    ReactionFile(name: "Secondary to Tertiary Shift", filename: "MethylPentylCation_short", transitionState: -1),
                    ReactionFile(name: "Secondary to Tertiary Shift (Extended Animation)", filename: "Rearrangement_MethylPentylCation", transitionState: -1)
                ].sorted(by: { $0.name < $1.name })),
    SubCategory(name: "Oxidation",
                reactions: [
                    ReactionFile(name: "Epoxidation: Peracid + Trans-2-Butene", filename: "Butene_EA_dimethyloxirane", transitionState: 527)
                ].sorted(by: { $0.name < $1.name })),
    ...
    SubCategory(name: "Carbonyl Addition",
                reactions: [
                    ReactionFile(name: "Addition: Cyanide + Acetone", filename: "AdN_Acetone", transitionState: 429),
    ...
    SubCategory(name: "Radical",
                reactions: [
                    ReactionFile(name: "Intramolecular HAT", filename: "HAT_Butoxy", transitionState: 426),
    ...
    SubCategory(name: "Pericyclic",
                reactions: [
                    ...
                    ReactionFile(name: "Diels-Alder: 1,3-Butadiene + Ethylene", filename: "butadiene_ethene_DA_cyclohexane_complete", transitionState: 200),
                    ...
                    ReactionFile(name: "OsO₄ + Ethylene", filename: "OsO4_complete", transitionState: 501),
                    ReactionFile(name: "1,3-Dipolar Cycloaddition: O₃ + Ethylene", filename: "Ozone_complete", transitionState: 499),
                ].sorted(by: { $0.name < $1.name })),
    SubCategory(name: "Aromatic Substitution",
                reactions: [
                    ReactionFile(name: "Friedel-Crafts Acylation", filename: "Toluene_acylium_AlCl4_TS_tolylethanone", transitionState: 499),
                ].sorted(by: { $0.name < $1.name })),
